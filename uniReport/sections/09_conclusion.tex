...
This project applied a full process analytics pipeline to the Road Traffic Fine Management event log, combining process discovery, conformance checking, predictive monitoring, and prescriptive recommendations. The research questions posed in the introduction can now be answered:
...
\textbf{RQ4 (Prescriptive Analytics):} SHAP analysis identifies the presence of penalty-related activities and elapsed time as the dominant risk drivers. A threshold-based policy translates predicted probabilities into tiered action recommendations (escalate, remind, or monitor), allowing staff to intervene before cases reach credit collection.
...
\label{sub:ai_declaration}

This project made use of generative AI assistants — specifically Google Gemini and Anthropic Claude — throughout the development process. The tools were employed for exploratory data analysis, writing and debugging Python code, and refining written formulations in this report. All AI-generated outputs were reviewed, verified, and adapted by the authors. The analytical decisions, methodological design, and final interpretation of results remain the intellectual responsibility of the group members.